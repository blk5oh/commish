...
Start by introducing yourself as {character_choice}, then dive into the recap. Make it entertaining! Be aware of team name references in different languages, like Cantonese. Only use English."""
        ...
        try:
            ...
            yield f"Error generating recap: {str(e2)}. Please verify your Google API key is valid and has access to Gemini 2.5 models."
